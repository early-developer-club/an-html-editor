...
<html lang="ko">
  <head>
    <meta charset="utf-8" />
    <title>카펜터 연필 - 전문가의 손길, 맞춤 제작 연필</title>
    <style>
      @import url("https://cdn.jsdelivr.net/gh/orioncactus/pretendard/dist/web/static/pretendard.css");

      :root {
        --primary-color: 0.568 0.2 26.4;
        --accent-color: 0.74 0.156 69.1;
  ...
  <body style="width: 860px; margin: 0 auto; padding: 0; background: #ffffff">
    ...
    <div style="width: 860px; margin: 0 auto; background: var(--white); padding: 80px 60px; box-sizing: border-box">
      ...
      <div style="font-family: Pretendard; font-weight: 500; font-size: 16px; color: var(--black); margin-bottom: 16px">
        전문가의 작업 효율을 높이는 인체공학적 디자인의 연필
      </div>
      <div style="display: flex; gap: 100px; justify-content: flex-end; align-items: flex-end">
        <div style="display: flex; gap: 4px; align-items: center">
          <div style="background: var(--gray-color-300); width: 8px; height: 48px"></div>
          <div>
            <div style="font-family: Pretendard; font-weight: 600; font-size: 20px; color: var(--black)">소재</div>
            <div style="font-family: Pretendard; font-weight: 500; font-size: 16px; color: var(--black)">
              Poplar Wood
            </div>
          </div>
        </div>
        <div style="display: flex; gap: 4px; align-items: center">
          <div style="background: var(--gray-color-300); width: 8px; height: 48px"></div>
          <div>
            <div style="font-family: Pretendard; font-weight: 600; font-size: 20px; color: var(--black)">심 굵기</div>
            <div style="font-family: Pretendard; font-weight: 500; font-size: 16px; color: var(--black)">HB (기본)</div>
          </div>
        </div>
      </div>
    </div>
    ...
    <div style="width: 860px; margin: 0 auto; background: var(--white); font-family: Pretendard">
      ...
      >
        <div style="display: flex; flex-direction: column; gap: 20px; width: 100%">
          ...
          <div style="font-weight: bold; font-size: 28px; color: var(--black)">인체공학적 디자인</div>
          <div style="height: 2px; background: var(--black); width: 30px"></div>
          <div style="font-weight: 500; font-size: 16px; color: var(--black)">
            사각형 바디가 손에 안정적으로 잡히고,<br />바닥에 굴러 떨어지지 않아 작업에 집중할 수 있습니다.
          </div>
        </div>
        <img
      ...
      >
        <div style="display: flex; flex-direction: column; gap: 20px; width: 100%">
          ...
          <div style="font-weight: bold; font-size: 28px; color: var(--black)">맞춤 인쇄 가능</div>
          <div style="height: 2px; background: var(--black); width: 30px"></div>
          <div style="font-weight: 500; font-size: 16px; color: var(--black)">
            기업 로고, 슬로건을 인쇄하여<br />고급스러운 크라프트지 패키지에 넣어 배송됩니다.
          </div>
        </div>
        <img
      ...
      >
        <div style="display: flex; flex-direction: column; gap: 20px; width: 100%">
          ...
          <div style="font-weight: bold; font-size: 28px; color: var(--black)">견고한 흑연심</div>
          <div style="height: 2px; background: var(--black); width: 30px"></div>
          <div style="font-weight: 500; font-size: 16px; color: var(--black)">
            잘 부러지지 않는 HB 심이<br />거친 표면 위에서도 선명한 필기감을 제공합니다.
          </div>
        </div>
        <img
      ...
      <div style="height: 2px; background: var(--gray-color-300)"></div>
    </div>
    ...
    >
      <div style="display: flex; flex-direction: column; gap: 4px; align-items: center">
        ...
        <div style="font-weight: bold; font-size: 28px; color: var(--black); text-align: center">
          제작 가능 다양한 컬러 옵션
        </div>
      </div>
    ...
    >
      ...
      <div
        ...
        "
      >
        <div style="font-weight: 500; font-size: 12px; color: #dd2052; text-align: right; width: 100%">
          *사이즈는 1~2mm정도 오차가 있을 수 있습니다.
        </div>

        <!-- Table -->
        <div style="width: 100%; border-top: 2px solid var(--black); border-bottom: 2px solid var(--black)">
          <div style="display: flex; border-bottom: 2px solid var(--gray-color-300)">
            <div
              style="
                flex: 1;
                ...
                font-size: 20px;
                text-align: center;
                border-right: 2px solid var(--gray-color-300);
              "
            >
              실제 제품 사이즈
            </div>
        ...
        <div style="font-weight: 600; font-size: 16px; color: var(--black); text-align: right; width: 100%">
          단위 : mm
        </div>
      </div>
    </div>
    ...
    <div style="width: 860px; margin: 0 auto; background: #202020; font-family: Pretendard; padding: 70px 0">
      <div style="padding: 0 110px; display: flex; flex-direction: column; gap: 16px">
        ...
        <div style="height: 2px; background: var(--gray-color-300); width: 100%"></div>
        ...
        <div style="padding-left: 20px">
          <div style="display: flex; flex-direction: column; gap: 8px; margin-bottom: 20px">
            ...
            >
              ...
              <span style="max-width: 500px">
                화이트 인쇄 후 컬러 인쇄를 순차적으로 진행하기 때문에, <br />컬러 인쇄 부분과 화이트 인쇄 부분이 약간
                밀려 제작될 수 있습니다.
              </span>
            </div>
            <div style="display: flex; gap: 8px; padding-left: 20px">
              <img
                src="https://tqbgeliijjkochgznpba.supabase.co/storage/v1/object/public/images/6ece3912-cdd4-4111-8701-08907a54198c/f79a03a7-75ef-411c-b261-211f728510af.webp"
                alt="화이트 인쇄 밀림 현상"
                style="width: 190px; height: 124px; object-fit: cover"
              />
            </div>
          </div>
          <div style="display: flex; flex-direction: column; gap: 8px; margin-bottom: 20px">
            ...
            >
              <span>—</span>
              <span style="max-width: 500px">
                나무 원자재에 도장되어 있는 제작 특성상 스크래치 및 얼룩이 있을 수 있으며, <br />이는 반품 사유에
                해당되지 않습니다.
              </span>
            </div>
            <div style="display: flex; gap: 8px; padding-left: 20px">
              <img
                src="https://tqbgeliijjkochgznpba.supabase.co/storage/v1/object/public/images/6ece3912-cdd4-4111-8701-08907a54198c/4eb91329-d773-4ee8-90ac-5518cfa45dd4.webp"
                alt="스크래치 및 얼룩 안내"
                style="width: 190px; height: 124px; object-fit: cover"
              />
            </div>
          ...
          <div style="display: flex; flex-direction: column; gap: 8px; margin-bottom: 20px">
            ...
            >
              <span>—</span>
              <span style="max-width: 500px">
                누드 색상은 원자재 나무 질감에 따라 색상 차이가 있을 수 있으며, <br />밝은 색상 바디는 나무 질감이 비칠
                수 있습니다.
              </span>
            </div>
            <div style="display: flex; gap: 8px; padding-left: 20px">
              <img
                src="https://tqbgeliijjkochgznpba.supabase.co/storage/v1/object/public/images/6ece3912-cdd4-4111-8701-08907a54198c/0ced5b0f-5dc5-4073-a631-abbd1c1a61e3.webp"
                alt="누드 색상 랜덤"
                style="width: 190px; height: 124px; object-fit: cover"
              />
            </div>
    ...
    <div style="width: 860px; margin: 0 auto; background: var(--white); font-family: Pretendard; padding: 30px 0">
      <div style="padding: 0 110px; display: flex; flex-direction: column; gap: 28px">
        ...
        <div style="display: flex; flex-direction: column; gap: 8px">
          <div style="display: flex; gap: 4px; align-items: center">
            <span style="font-weight: 500; font-size: 16px; color: var(--black)"
              >— 고객님께서 주문하신 제품은 입금 확인 후 제작 및 배송이 진행됩니다.</span
            >
          </div>
          <div style="display: flex; gap: 4px; align-items: center">
            <span style="font-weight: 500; font-size: 16px; color: var(--black)"
              >— 주문 제작 상품 특성상 제작이 시작된 이후에는 환불이 불가합니다.</span
            >
          </div>
          <div style="display: flex; gap: 4px; align-items: center">
            <span style="font-weight: 500; font-size: 16px; color: var(--black)"
              >— 도서·산간 지역은 추가 배송비가 부가되며, 해외 배송은 불가합니다.</span
            >
          </div>
          <div style="display: flex; gap: 4px; align-items: center">
            <span style="font-weight: 500; font-size: 16px; color: var(--black)"
              >— 주문 상태가 '상품 준비중'으로 변경된 이후 영업일 기준 1~2일 이내 출고됩니다. (주말 및 공휴일 제외) 현재
              묶음 배송, 도서산간 지역, 해외 배송은 지원되지 않습니다.</span
            >
          </div>
        </div>
      </div>
